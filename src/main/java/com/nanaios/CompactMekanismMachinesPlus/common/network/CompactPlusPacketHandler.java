...
public class CompactPlusPacketHandler extends BasePacketHandler {
    public CompactPlusPacketHandler(IEventBus modEventBus, Version version) {
    ...
    protected void registerClientToServer(PacketRegistrar registrar) {
        ...
        registrar.play(PacketCompactPlusTileButtonPress.TYPE,PacketCompactPlusTileButtonPress.STREAM_CODEC);
    }
